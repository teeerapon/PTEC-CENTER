...
//   const menus = {
//     title: ['SMART-CAR', 'SMART-BILL', 'ESG'],
//     path: ['/SMB/StartForms', '/SMB/Payment', '/SMB/Esg'],
//     icon: [<CarCrashIcon />, <RequestQuoteIcon />, <AssessmentIcon />]
//   }
...
//                   sx={{ color: 'inherit', }}
//                 >
//                   <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>{text}</Typography>
//                 </Button>
//               </Link>
//             ))} */}
//           </Box>
//           <Tooltip
//             title={
//               window.location.pathname === '/SMB/StartForms' || window.location.pathname === '/SMB/FormUpdate' ? 'SMART-CAR LIST'
//                 : 'SMART-BILL LIST'
//             }>
//             <IconButton sx={{ mx: 10 }}>
//               <ArticleIcon
