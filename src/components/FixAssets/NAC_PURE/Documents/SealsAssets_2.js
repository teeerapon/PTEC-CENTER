                        ...
                        .then((resIII) => {
                          if (i + 1 === serviceList.length) {
                            swal("แจ้งเตือน", 'อัปเดตรายการแล้ว', "success", { buttons: false, timer: 2000 }).then((value) => {
                              ...
                              window.location.href = '/NAC/SealsAssets_2?' + pathLink
                            });
                          }
                        })
                    }
                      ...
                      <StyledTableCell align="start" colSpan={4}>
                        <TextField
                          ...
                          InputProps={{
                            ...
                            endAdornment: (
                              <InputAdornment position="start">
                                <Typography color="black" sx={{ pl: 2 }}>
                                  บาท
                                </Typography>
                              </InputAdornment>
                            ),
                      ...
                      <StyledTableCell align="start" colSpan={3}>
                        <LocalizationProvider dateAdapter={AdapterDayjs}>
                          <DateTimePicker
                            ...
                            sx={{ width: '100%' }}
                            timezone="UTC"
                            value={sendHeader[0].realPrice_Date ? dayjs(sendHeader[0].realPrice_Date) : null}
                            onChange={(newValue) => {
                              const listHeader = [...sendHeader]
                              listHeader[0]['realPrice_Date'] = dayjs(newValue).format('YYYY-MM-DD HH:mm')
                              setSendHeader(listHeader)
                            }}
                            ampm={false}
                            slotProps={{
